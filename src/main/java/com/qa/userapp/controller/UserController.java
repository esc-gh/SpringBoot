...
public class UserController {
	...
	public ResponseEntity<User> createUser(@Valid @RequestBody User user) {
		...
		// - serialisation is converting an object into some file format, such as JSON
		// or XML
		// - deserialisation is converting some file data, i.e, JSON or XML, into some
		// object
	...
	public ResponseEntity<User> updateUser(@PathVariable("id") long id, @Valid @RequestBody User user) {
		...
		ResponseEntity<User> response = new ResponseEntity<User>(updatedUser, HttpStatus.ACCEPTED);
		return response;
	}
	...
	public ResponseEntity<?> deleteUser(@PathVariable("id") long id) {
		...
		ResponseEntity<User> response = new ResponseEntity<User>(deletedUser, HttpStatus.ACCEPTED);
		return response;
	}
